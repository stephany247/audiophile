...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    "inline-flex items-center justify-center uppercase font-manrope text-subtitle px-6 py-3 rounded-none transition-all duration-300 disabled:bg-gray cursor-pointer";
